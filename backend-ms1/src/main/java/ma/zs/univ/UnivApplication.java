...
public class UnivApplication {
    ...
    private static void addPermission(List<ModelPermission> modelPermissions) {
        modelPermissions.add(new ModelPermission("Trim"));
        modelPermissions.add(new ModelPermission("CategorieLocale"));
        modelPermissions.add(new ModelPermission("TypeLocale38Detail"));
        modelPermissions.add(new ModelPermission("Rue"));
        modelPermissions.add(new ModelPermission("Ville"));
        modelPermissions.add(new ModelPermission("NotificationRetardDeuxiemeNiveau"));
        modelPermissions.add(new ModelPermission("Locale38Detail"));
        modelPermissions.add(new ModelPermission("NotificationRetardDeuxiemeNiveauDetail"));
        modelPermissions.add(new ModelPermission("Secteur"));
        modelPermissions.add(new ModelPermission("Taxe38Detail"));
        modelPermissions.add(new ModelPermission("NotificationRetardPremierNiveau"));
        modelPermissions.add(new ModelPermission("Locale"));
        modelPermissions.add(new ModelPermission("Redevable"));
        modelPermissions.add(new ModelPermission("Taxe38"));
        modelPermissions.add(new ModelPermission("TauxTaxe38"));
        modelPermissions.add(new ModelPermission("NotificationRetardDeuxiemeNiveauDetailType38"));
        modelPermissions.add(new ModelPermission("Quartier"));
        modelPermissions.add(new ModelPermission("NotificationRetardTroisiemeNiveau"));
