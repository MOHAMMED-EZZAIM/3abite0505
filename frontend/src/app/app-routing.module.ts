...
import {PageAcceuilComponent} from "./module/admin/view/page-acceuil/page-acceuil.component";
import {ListRedevableComponent} from "./equipe-taxe38/list-redevable/list-redevable.component";
@NgModule({
    imports: [
        RouterModule.forRoot(
            [
                {path: '', component: PageAcceuilComponent},
                {path: 'logine', component: LoginAdminComponent},
                {path: 'listReadvableEz', component: ListRedevableComponent},
